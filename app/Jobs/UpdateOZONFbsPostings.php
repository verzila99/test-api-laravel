                    ...
                    foreach ($value['products'] as $product) {
                        ...
                        DB::table('ozon_fbs_postings')->updateOrInsert([
                            ...
                            'sku' => $product['sku'],
                                ...
                                'marketplace_service_item_deliv_to_customer' => $financialDataProduct['item_services']['marketplace_service_item_deliv_to_customer'] ?? null,
                                'marketplace_service_item_direct_flow_trans' => $financialDataProduct['item_services']['marketplace_service_item_direct_flow_trans'] ?? null,
                                'marketplace_service_item_dropoff_ff' => $financialDataProduct['item_services']['marketplace_service_item_dropoff_ff'] ?? null,
                                'marketplace_service_item_dropoff_pvz' => $financialDataProduct['item_services']['marketplace_service_item_dropoff_pvz'] ?? null,
                                'marketplace_service_item_dropoff_sc' => $financialDataProduct['item_services']['marketplace_service_item_dropoff_sc'] ?? null,
                                'marketplace_service_item_fulfillment' => $financialDataProduct['item_services']['marketplace_service_item_fulfillment'] ?? null,
                                'marketplace_service_item_pickup' => $financialDataProduct['item_services']['marketplace_service_item_pickup'] ?? null,
                                'marketplace_service_item_return_after_deliv_to_customer' => $financialDataProduct['item_services']['marketplace_service_item_return_after_deliv_to_customer'] ?? null,
                                'marketplace_service_item_return_flow_trans' => $financialDataProduct['item_services']['marketplace_service_item_return_flow_trans'] ?? null,
                                'marketplace_service_item_return_not_deliv_to_customer' => $financialDataProduct['item_services']['marketplace_service_item_return_not_deliv_to_customer'] ?? null,
                                'marketplace_service_item_return_part_goods_customer' => $financialDataProduct['item_services']['marketplace_service_item_return_part_goods_customer'] ?? null,
