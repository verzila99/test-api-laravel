...
class Kernel extends ConsoleKernel
{
    ...
    {
        $schedule->job(new UpdateOZONPostings)->timezone('Europe/Moscow')->dailyAt('0:00');
        ...
        $schedule->job(new UpdateWBSalesReportByRealization)->timezone('Europe/Moscow')->dailyAt('0:00');
